...
class _WomenScreenState extends State<WomenScreen>
  ...
  final List<Map<String, dynamic>> _categories = [
    {
      ...
      'gradient': [const Color(0xFFF06292), const Color(0xFFF8BBD0)]
    },
    {
      'name': 'Dresses',
      'icon': Icons.woman,
      'gradient': [const Color(0xFFBA68C8), const Color(0xFFE1BEE7)]
    },
    {
      'name': 'Tops',
      'icon': Icons.checkroom,
      'gradient': [const Color(0xFF4DB6AC), const Color(0xFFB2DFDB)]
    },
    {
      'name': 'Skirts',
      'icon': Icons.layers,
      'gradient': [const Color(0xFFFFB74D), const Color(0xFFFFE0B2)]
    },
    {
      'name': 'Heels',
      'icon': Icons.do_not_step,
      'gradient': [const Color(0xFFE57373), const Color(0xFFFFCDD2)]
    },
    {
      'name': 'Bags',
      'icon': Icons.shopping_bag,
      'gradient': [const Color(0xFF7986CB), const Color(0xFFC5CAE9)]
    },
    {
      'name': 'Jewelry',
      'icon': Icons.diamond,
      'gradient': [const Color(0xFFFFD54F), const Color(0xFFFFF9C4)]
    },
  ];
  ...
  final List<Map<String, String>> _banners = [
    ...
    {
      'image':
          'https://images.unsplash.com/photo-1534126511673-b6899657816a?w=1200',
      'title': 'Designer Bags',
                        ...
                        Wrap(
                            ...
                            children: _availableBrands.map((brand) {
                              ...
                              return FilterChip(
                                  ...
                                  checkmarkColor: Colors.pink.shade900);
                            }).toList()),
                      ],
                    ),
                  ),
  ...
  Widget _buildChoiceChip(
    ...
    return ChoiceChip(
        ...
        labelStyle:
            TextStyle(color: isSelected ? Colors.pink.shade900 : Colors.black));
  }
