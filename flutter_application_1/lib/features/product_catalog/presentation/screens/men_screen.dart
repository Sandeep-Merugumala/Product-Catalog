...
class _MenScreenState extends State<MenScreen> with TickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _categories = [
    {'name': 'All', 'icon': Icons.grid_view, 'gradient': [const Color(0xFF667eea), const Color(0xFF764ba2)]},
    {'name': 'T-Shirts', 'icon': Icons.checkroom, 'gradient': [const Color(0xFFf093fb), const Color(0xFFF5576c)]},
    {'name': 'Shirts', 'icon': Icons.business, 'gradient': [const Color(0xFF4facfe), const Color(0xFF00f2fe)]},
    {'name': 'Jeans', 'icon': Icons.dry_cleaning, 'gradient': [const Color(0xFF43e97b), const Color(0xFF38f9d7)]},
    {'name': 'Shoes', 'icon': Icons.hiking, 'gradient': [const Color(0xFFfa709a), const Color(0xFFfee140)]},
    {'name': 'Watches', 'icon': Icons.watch, 'gradient': [const Color(0xFF30cfd0), const Color(0xFF330867)]},
    {'name': 'Active', 'icon': Icons.fitness_center, 'gradient': [const Color(0xFFa8edea), const Color(0xFFfed6e3)]},
  ];

  final List<Map<String, String>> _banners = [
    {
      'image': 'https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?w=1200',
      'title': 'New Season',
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setStateModal) {
          return Container(
            ...
            padding: const EdgeInsets.fromLTRB(20, 20, 20, 0), // Remove bottom padding here
            child: Column(
              children: [
    ...
    return SliverAppBar(
      ...
      title: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(gradient: LinearGradient(colors: [Colors.blue.shade600, Colors.purple.shade600]), borderRadius: BorderRadius.circular(10)),
          ...
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Men's Fashion", style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -0.5)),
              Text("Premium Collection", style: TextStyle(color: Colors.grey, fontSize: 10, fontWeight: FontWeight.w500)),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(gradient: LinearGradient(colors: [Colors.blue.shade400, Colors.purple.shade400]), borderRadius: BorderRadius.circular(10)),
            child: const Icon(Icons.search, color: Colors.white, size: 20),
          ),
          const SizedBox(width: 15),
          const Expanded(child: TextField(decoration: InputDecoration(hintText: "Search brands, products...", border: InputBorder.none))),
          ...
          children: _banners.asMap().entries.map((entry) {
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                gradient: _currentBannerIndex == entry.key ? LinearGradient(colors: [Colors.blue.shade600, Colors.purple.shade600]) : null,
                        ...
                        if (product['tag'] != null)
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: product['tag'].contains('%') ? Colors.red : Colors.black, borderRadius: BorderRadius.circular(8)),
                              ...
                              Row(
                                children: [
                                  ...
                                  if (product['oldPrice'] != null) ...[
                                    ...
                                    Text("\$${product['oldPrice'].toStringAsFixed(0)}", style: TextStyle(decoration: TextDecoration.lineThrough, color: Colors.grey.shade400, fontSize: 12)),
                                  ],
                                ],
                              ),
                            ],
